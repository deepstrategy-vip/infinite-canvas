...
```text
请从 https://github.com/deepstrategy-vip/infinite-canvas.git 安装 Infinite Canvas Codex 插件。
...
```bash
mkdir -p ~/plugins
git clone https://github.com/deepstrategy-vip/infinite-canvas.git ~/plugins/infinite-canvas
```
